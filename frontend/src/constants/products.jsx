...
export const productDatabase = {
  'maaposhan-kit': {
    ...
    benefits: [
      { id: 1, icon: <Leaf size={16} />, text: 'Pure Organic Recovery Paste' },
      { id: 2, icon: <HeartPulse size={16} />, text: 'Essential Mom Self-Care' },
      { id: 3, icon: <Sparkles size={16} />, text: 'Delicate Baby Essentials' },
      { id: 4, icon: <Truck size={16} />, text: 'Luxury Gifting Box' }
    ],
    details: {
  ...
  'maaposhan-harira-gentle': {
    ...
    benefits: [
      { id: 1, icon: <Leaf size={16} />, text: 'Gentle on C-Section Healing' },
      { id: 2, icon: <HeartPulse size={16} />, text: 'Anti-inflammatory Mustard Oil' },
      { id: 3, icon: <Sparkles size={16} />, text: 'Digestive Comfort Spices' },
      { id: 4, icon: <Truck size={16} />, text: 'Lactation & Strength Support' }
    ],
    details: {
  ...
  'maaposhan-harira-kit': {
    ...
    benefits: [
      { id: 1, icon: <Leaf size={16} />, text: 'Pre-Measured Packet System' },
      { id: 2, icon: <HeartPulse size={16} />, text: 'Pure Desi Ghee Included' },
      { id: 3, icon: <Sparkles size={16} />, text: 'Natural Jaggery Sachet' },
      { id: 4, icon: <Truck size={16} />, text: 'Ready in 5 Minutes' }
    ],
    details: {

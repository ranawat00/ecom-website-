        ...
        <div className="navbar-container">
          ...
          <div className={`navbar-menu ${isOpen ? 'active' : ''}`}>
            ...
            <div className="mobile-only-menu-actions">
              <button className="mobile-menu-action-btn" onClick={() => { setIsOpen(false); toggleTheme(); }} title="Toggle Theme">
                {isDarkMode ? <Sun size={20} /> : <Moon size={20} />}
                <span>{isDarkMode ? 'Light Mode' : 'Dark Mode'}</span>
              </button>
              <button className="mobile-menu-action-btn" onClick={() => { setIsOpen(false); handleAccountClick(); }} title="Account Profile">
                <svg

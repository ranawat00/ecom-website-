...
const supportArticles = [
    { id: 1, type: 'support', title: 'How to track my order?', content: 'To track your order, visit the "Order History" section in your profile dashboard. Once your artisanal harvest is shipped, a real-time tracking link will be sent to your mobile number and email.', link: '/help' },
    ...
    { id: 9, type: 'support', title: 'Bulk orders and corporate gifting', content: 'For bulk inquiries or custom gifting solutions, please connect with us via the contact form or email support@amritan.com.', link: '/help' },
    { id: 10, type: 'support', title: 'How to connect with the support team?', content: 'Connect with our support team via Live Chat, Email (support@amritan.com), or Phone (+91 078200 50723). Available Mon-Sat, 9AM-7PM.', link: '/help' }
];
